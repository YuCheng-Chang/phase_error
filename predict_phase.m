...
%   hilbertwindow(1) is the left window width hilbertwindow(2) is the right window width
...
if nargin < 7
    iterations = edge + hilbertwindow(2);
else
...
data_filtered_withoutedge_predicted_hilbertwindow = ...
    data_filtered_withoutedge_predicted(end-hilbertwindow(1)-hilbertwindow(2)+1:end,:);
